...
<button style="width:200px;height:60px;font-size:20px;border-style:none;border-bottom-style:solid;font-family:Helvetica" onclick="var drug_1 = document.getElementById('drug_1').value
	...
	<div>
<button onclick = "window.alert('Routine logged');" style="width:200px;height:60px;font-size:20px;border-style:none;border-bottom-style:solid;font-family:Helvetica">Verify your prescription routine</button>
</div>
