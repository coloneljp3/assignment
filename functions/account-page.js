...
<h2 class="h2_styles">Medical Conditions</h2><div><div id = "conditions">`+disease_list+`</div>
    ...
    <button style="width:200px;height:100px;font-size:20px;border-style:none;border-bottom-style:solid;font-family:Helvetica" onclick = "var drug_1 = document.getElementById('drug_1').value
...
<button style="width:200px;height:60px;font-size:20px;border-style:none;border-bottom-style:solid;font-family:Helvetica" onclick="window.alert('Routine logged');var drug_1 = document.getElementById('drug_1').value
    ...
    document.getElementById('prediction').innerHTML = xml.responseText        
        ...
        xml.send('drug_1='+drug_1+'&amp;drug_2='+drug_2)">Enter
	<div>
...
xml.send('username='`+username+`'&daily_dosage='`+newDate+`)" style="width:200px;height:60px;font-size:20px;border-style:none;border-bottom-style:solid;font-family:Helvetica">Verify your prescription routine</button>
</div>
